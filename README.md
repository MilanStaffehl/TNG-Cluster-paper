...
The code in this repository requires Python 3.10 or higher to run. Additionally, to create figures, the simulation data of at least the TNG300 simulation and the TNG-Cluster simulation must be available. You can find them on the official IllustrisTNG [data release page](https://www.tng-project.org/data/). 

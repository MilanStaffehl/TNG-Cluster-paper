...
#SBATCH -D ./
#SBATCH -J MS002R
#SBATCH --partition=p.huge    # request node on partition with 1TB memory nodes
...
srun python3 ~/thesisProject/scripts/radial_profiles/plot_binned_radial_profile.py -s MAIN_SIM -p $SLURM_CPUS_PER_TASK -f
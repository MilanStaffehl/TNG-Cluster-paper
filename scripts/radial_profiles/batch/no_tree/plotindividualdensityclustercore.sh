...
srun python3 ~/thesisProject/scripts/radial_profiles/plot_individual_radial_profiles.py -s TNG-Cluster -w density --cluster-core --split-by-velocity -f --log -vv --absolute-distances
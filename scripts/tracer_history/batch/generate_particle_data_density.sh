#!/bin/bash -l
#
#SBATCH -o /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/out_generate_density.%j
#SBATCH -e /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/err_generate_density.%j
#SBATCH -D ./
#SBATCH -J PDCL-DENS
...
srun python3 ~/thesisProject/scripts/tracer_history/plot_quantity_with_time.py density -p $SLURM_CPUS_PER_TASK -u -fo -x -f
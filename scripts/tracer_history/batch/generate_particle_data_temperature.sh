#!/bin/bash -l
#
#SBATCH -o /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/out_generate_temperature.%j
#SBATCH -e /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/err_generate_temperature.%j
#SBATCH -D ./
#SBATCH -J PDCL-T
...
srun python3 ~/thesisProject/scripts/tracer_history/plot_quantity_with_time.py temperature -p $SLURM_CPUS_PER_TASK -u -x -f
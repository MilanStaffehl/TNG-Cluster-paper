#!/bin/bash -l
#
#SBATCH -o /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/out_53_TNG_Cluster.%j
#SBATCH -e /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/err_53_TNG_Cluster.%j
#SBATCH -D ./
#SBATCH -J TDCL-53
...
srun python3 ~/thesisProject/scripts/tracer_history/generate_tracer_data.py trace-back -s TNG-Cluster -p $SLURM_CPUS_PER_TASK -n 53
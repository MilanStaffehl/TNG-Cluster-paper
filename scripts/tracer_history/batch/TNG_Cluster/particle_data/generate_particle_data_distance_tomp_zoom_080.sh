#!/bin/bash -l
#
#SBATCH -o /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/out_generate_distance_z080.%j
#SBATCH -e /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/err_generate_distance_z080.%j
#SBATCH -D ./
#SBATCH -J DMP-080
...
srun python3 ~/thesisProject/scripts/tracer_history/plot_quantity_with_time.py distance -p $SLURM_CPUS_PER_TASK -u -fo -x -f --zoom-in 80

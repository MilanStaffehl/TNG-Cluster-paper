#!/bin/bash -l
#
#SBATCH -o /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/out_generate_mass.%j
#SBATCH -e /vera/u/mista/thesisProject/scripts/tracer_history/batch/output/err_generate_mass.%j
#SBATCH -D ./
#SBATCH -J PDCL-MASS
...
srun python3 ~/thesisProject/scripts/tracer_history/plot_quantity_with_time.py mass -p $SLURM_CPUS_PER_TASK -u -fo -x -f